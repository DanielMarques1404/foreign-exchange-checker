...
export const CurrencyItem = (props: CurrencyItemProps) => {
  ...
  return (
    <button
      type="button"
      onClick={onSelect}
      className="flex h-12 w-full cursor-pointer items-center justify-between gap-2 select-none rounded-md border-2 border-transparent bg-Neutral-900 px-2 py-3 text-left hover:border-Neutral-100 my-2"
    >
