...
export const CurrencyItemGroup = ({
  ...
  return (
    <div className="scrollbar-hidden flex h-114.5 w-77.75 flex-col overflow-y-auto overscroll-contain bg-Neutral-900">
      <label className="flex items-center gap-2 rounded-md border border-Neutral-500 bg-Neutral-800 p-3 text-Neutral-200">
        <img
        ...
        <input
          ...
          className="text-[16px] w-full bg-transparent text-Neutral-200 placeholder:text-Neutral-300 outline-none"
        />
      </label>
